---
slug: noninterdependent
name: noninterdependent
semantic_type: property
canonical_definition: ''
formal_spec: Property where groups of players cannot influence players outside the
  group, as in the collision model where collisions only affect those on the same
  arm.
aliases: []
status: canonical
human_notes: ''
