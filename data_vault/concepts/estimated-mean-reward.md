---
slug: estimated-mean-reward
name: estimated-mean-reward
semantic_type: quantity
canonical_definition: ''
formal_spec: The estimated expected reward for arm i for player n, denoted μ̂_n,i,
  based on exploration samples.
aliases: []
status: canonical
human_notes: ''
generalizes: []
