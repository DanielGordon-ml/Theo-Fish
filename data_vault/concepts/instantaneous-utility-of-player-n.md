---
slug: instantaneous-utility-of-player-n
name: instantaneous utility of player n
semantic_type: operator
canonical_definition: ''
formal_spec: $v_n(\pmb a) = r_{n,a_n} \eta_{a_n}(\pmb a)$
aliases: []
status: canonical
human_notes: ''
generalizes: []
...
# instantaneous utility of player n
