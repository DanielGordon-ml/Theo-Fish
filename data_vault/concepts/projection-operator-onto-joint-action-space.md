---
slug: projection-operator-onto-joint-action-space
name: projection operator onto joint action space
semantic_type: operator
canonical_definition: ''
formal_spec: ∏_{A1×...×AN} maps a vector to its projection onto the Cartesian product
  of action sets
aliases: []
status: canonical
human_notes: ''
...
# projection operator onto joint action space
