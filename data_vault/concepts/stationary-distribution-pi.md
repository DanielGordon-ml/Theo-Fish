---
slug: stationary-distribution-pi
name: stationary distribution π
semantic_type: structure
canonical_definition: ''
formal_spec: a probability distribution over [n] that is invariant under the transition
  matrix of M, satisfying πP = π
aliases: []
status: canonical
human_notes: ''
generalizes: []
