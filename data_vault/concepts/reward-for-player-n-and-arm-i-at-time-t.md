---
slug: reward-for-player-n-and-arm-i-at-time-t
name: reward for player n and arm i at time t
semantic_type: quantity
canonical_definition: ''
formal_spec: random variable $r_{n,i}(t)$ with distribution on [0,1]
aliases: []
status: canonical
human_notes: ''
generalizes: []
...
# reward for player n and arm i at time t
