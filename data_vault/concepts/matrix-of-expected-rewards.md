---
slug: matrix-of-expected-rewards
name: matrix-of-expected-rewards
semantic_type: space
canonical_definition: ''
formal_spec: Matrix where rows correspond to players, columns to arms, and entries
  are expected rewards for each player-arm pair.
aliases: []
status: canonical
human_notes: ''
generalizes: []
