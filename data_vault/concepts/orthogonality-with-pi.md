---
slug: orthogonality-with-pi
name: orthogonality-with-π
semantic_type: relation
canonical_definition: ''
formal_spec: for vectors x and y in R^n, x is orthogonal to y with respect to π if
  ⟨x, y⟩_π = 0
aliases: []
status: canonical
human_notes: ''
