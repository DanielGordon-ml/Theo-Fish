...
name: Congestion games
semantic_type: class
canonical_definition: ''
formal_spec: Games where players select subsets of resources, with the cost per resource
  depending on the number of players using it.
aliases: []
status: canonical
human_notes: ''
generalizes: []
