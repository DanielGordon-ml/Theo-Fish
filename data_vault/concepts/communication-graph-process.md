---
slug: communication-graph-process
name: communication-graph-process
semantic_type: structure
canonical_definition: ''
formal_spec: G(t) = (\mathcal{V}, \mathcal{E}(t)), undirected graph at time t
aliases: []
status: canonical
human_notes: ''
generalizes: []
