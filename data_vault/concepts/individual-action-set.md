---
slug: individual-action-set
name: individual action set
semantic_type: space
canonical_definition: ''
formal_spec: The set of possible actions for an agent, assumed to be convex and compact.
aliases: []
status: canonical
human_notes: ''
generalizes: []
