---
slug: exploration-error-probability
name: exploration-error-probability
semantic_type: quantity
canonical_definition: ''
formal_spec: The probability P_e,k that the estimated optimal assignment differs from
  the true optimal assignment at epoch k.
aliases: []
status: canonical
human_notes: ''
generalizes: []
