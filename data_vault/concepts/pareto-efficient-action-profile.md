---
slug: pareto-efficient-action-profile
name: pareto_efficient_action_profile
semantic_type: structure
canonical_definition: ''
formal_spec: A joint action such that no other joint action can make at least one
  agent better off without making any other worse off.
aliases: []
status: canonical
human_notes: ''
generalizes: []
...
# pareto_efficient_action_profile
