---
slug: explore-then-commit-strategy
name: explore-then-commit-strategy
semantic_type: structure
canonical_definition: ''
formal_spec: A strategy where agents first explore by random action sampling, then
  commit to actions based on collective satisfaction.
aliases: []
status: canonical
human_notes: ''
generalizes: []
