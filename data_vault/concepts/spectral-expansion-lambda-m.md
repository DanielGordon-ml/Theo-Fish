---
slug: spectral-expansion-lambda-m
name: spectral expansion λ(M)
semantic_type: property
canonical_definition: ''
formal_spec: λ(M) is the second largest eigenvalue in absolute value of the transition
  matrix of M, used to measure convergence rate
aliases: []
status: canonical
human_notes: ''
generalizes: []
