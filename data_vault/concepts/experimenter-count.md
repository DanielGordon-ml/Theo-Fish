---
slug: experimenter-count
name: experimenter count
semantic_type: quantity
canonical_definition: ''
formal_spec: Parameter c, representing the number of experimenters in the learning
  algorithm, often set to the number of agents n.
aliases: []
status: canonical
human_notes: ''
generalizes: []
