---
slug: uncoupled-learning-rule
name: uncoupled learning rule
semantic_type: property
canonical_definition: ''
formal_spec: p_i(t) = F_i(a(0),...,a(t-1); U_i), depending only on observed actions
  and agent i's own utility function.
aliases: []
status: canonical
human_notes: ''
generalizes: []
