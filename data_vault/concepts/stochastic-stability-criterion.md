---
slug: stochastic-stability-criterion
name: stochastic stability criterion
semantic_type: criterion
canonical_definition: ''
formal_spec: A selection criterion based on minimizing the total resistance of spanning
  trees in the resistance graph.
aliases: []
status: canonical
human_notes: ''
generalizes: []
