---
slug: optimal-action-profile
name: optimal action profile
semantic_type: structure
canonical_definition: ''
formal_spec: An action profile that maximizes a defined global objective, such as
  the sum of all players' rewards or system welfare.
aliases: []
status: canonical
human_notes: ''
generalizes: []
