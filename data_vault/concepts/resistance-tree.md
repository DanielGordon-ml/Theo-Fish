---
slug: resistance-tree
name: resistance tree
semantic_type: structure
canonical_definition: ''
formal_spec: A directed tree in the state space graph with edges weighted by resistances,
  used to compute stochastic potential.
aliases: []
status: canonical
human_notes: ''
generalizes: []
