---
slug: local-reward-function
name: local reward function
semantic_type: operator
canonical_definition: ''
formal_spec: A function defining the reward for an individual player given the actions
  taken, which may be unknown in bandit settings.
aliases: []
status: canonical
human_notes: ''
generalizes: []
