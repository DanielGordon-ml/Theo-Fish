---
slug: probability-distribution-p-i
name: probability distribution p_i
semantic_type: operator
canonical_definition: ''
formal_spec: 'p_i(·|h) : S_i → [0,1] such that p_i(s|h) > 0 if and only if s is a
  best reply to some sample of size k from h'
aliases: []
status: canonical
human_notes: ''
generalizes: []
