---
slug: lower-bound-on-expected-total-regret
name: lower bound on expected total regret
semantic_type: quantity
canonical_definition: ''
formal_spec: The theoretical minimum regret achievable, expressed as Ω(log T).
aliases: []
status: canonical
human_notes: ''
generalizes: []
...
# lower bound on expected total regret
