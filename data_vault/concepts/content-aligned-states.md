---
slug: content-aligned-states
name: content aligned states
semantic_type: space
canonical_definition: ''
formal_spec: "set C^0 of states [\bar{a}, \bar{u}, m] where for each agent i, \bar{u}_i\
  \ = U_i(\bar{a}) and m_i = C"
aliases: []
status: canonical
human_notes: ''
