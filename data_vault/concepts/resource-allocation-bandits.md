---
slug: resource-allocation-bandits
name: resource-allocation-bandits
semantic_type: class
canonical_definition: ''
formal_spec: Class of bandit problems where arms are interpreted as resources to be
  allocated among players, often with applications in wireless networks.
aliases: []
status: canonical
human_notes: ''
generalizes: []
