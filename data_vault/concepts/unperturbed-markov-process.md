---
slug: unperturbed-markov-process
name: unperturbed-markov-process
semantic_type: structure
canonical_definition: ''
formal_spec: The Markov process without experimentation, with transition probabilities
  P_hh'^0, where agents always choose best responses based on samples.
aliases: []
status: canonical
human_notes: ''
generalizes: []
