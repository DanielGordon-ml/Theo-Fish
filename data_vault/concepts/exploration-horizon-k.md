---
slug: exploration-horizon-k
name: exploration horizon K
semantic_type: quantity
canonical_definition: ''
formal_spec: Positive integer parameter that scales with system size to ensure reliable
  identification of Pareto-efficient profiles
aliases: []
status: canonical
human_notes: ''
generalizes: []
