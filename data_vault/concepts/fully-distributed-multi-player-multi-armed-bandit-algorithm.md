---
slug: fully-distributed-multi-player-multi-armed-bandit-algorithm
name: fully-distributed-multi-player-multi-armed-bandit-algorithm
semantic_type: structure
canonical_definition: ''
formal_spec: Algorithm based on modified dynamics for resource allocation and collision
  scenario, requiring no communication between players.
aliases: []
status: canonical
human_notes: ''
generalizes: []
...
# fully-distributed-multi-player-multi-armed-bandit-algorithm
