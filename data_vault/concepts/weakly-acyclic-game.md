---
slug: weakly-acyclic-game
name: weakly acyclic game
semantic_type: class
canonical_definition: ''
formal_spec: A game where from any strategy tuple, there exists a directed path in
  the best-reply graph to a strict Nash equilibrium.
aliases: []
status: canonical
human_notes: ''
generalizes: []
