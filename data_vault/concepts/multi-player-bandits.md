---
slug: multi-player-bandits
name: multi-player bandits
semantic_type: class
canonical_definition: ''
formal_spec: A class of bandit problems involving multiple players who interact, often
  under collision or game models, with bandit feedback.
aliases: []
status: canonical
human_notes: ''
generalizes: []
