---
slug: payoff-based-dynamics
name: payoff-based-dynamics
semantic_type: operator
canonical_definition: ''
formal_spec: Dynamics where each player updates based solely on own payoff information.
aliases: []
status: canonical
human_notes: ''
generalizes: []
