---
slug: stochastic-signal-generation
name: Stochastic signal generation
semantic_type: operator
canonical_definition: ''
formal_spec: An operator that generates the one-bit signal m_i^t based on a stochastic
  process defined in the paper.
aliases: []
status: canonical
human_notes: ''
generalizes: []
