---
slug: finite-strategic-form-game
name: finite-strategic-form-game
semantic_type: class
canonical_definition: ''
formal_spec: A game with a finite set of players, each with a finite set of actions,
  and defined payoff functions.
aliases: []
status: canonical
human_notes: ''
generalizes: []
